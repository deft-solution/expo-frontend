  ...
  return (
    <div className="relative w-full min-h-screen">
      <div className="flex flex-col items-center justify-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
        ...
        <h2 className="text-xl font-montserrat text-center">
          Sorry, the page you are looking for cannot be found
        </h2>
        <Link href="/">
          <button
            type="button"
            className="bg-main flex gap-4 font-montserrat text-white py-2 my-4 px-8 transform active:scale-95 transition-transform duration-150"
          >
